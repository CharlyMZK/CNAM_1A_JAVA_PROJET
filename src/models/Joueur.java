...
public class Joueur extends Sprite implements Commons {
    ...
    /**
     * Met l'image du vaiseau du joueur
     */
    public void setVaisseauImage() {
        ImageIcon ii = new ImageIcon(this.getMonVaisseau().getImage());
        Image img = ii.getImage();
        BufferedImage bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
        Graphics g = bi.createGraphics();
        g.drawImage(img, 0, 0, 54, 60, null);
        ImageIcon newIcon = new ImageIcon(bi);
        this.setImage(newIcon.getImage());
    }
